...
import clinic.ui.login.LoginController;
...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            if (LoginController.TYPE.equals("Receptionist")) {
                {
                    employee.setDisable(true);
                    donor.setDisable(true);
                    accounts.setDisable(true);
                    fund.setDisable(true);
                    medicines.setDisable(true);

//                    employee.setTooltip(new Tooltip("Access Has beem Denied!"));
                }
            }
            if (LoginController.TYPE.equals("Doctor")) {
                {
                    employee.setDisable(true);
                    donor.setDisable(true);
                    accounts.setDisable(true);
...
//                    employee.setTooltip(new Tooltip("Access Has beem Denied!"));
            ...
            if (LoginController.TYPE.equals("Store attandent")) {
                {
                    employee.setDisable(true);
                    donor.setDisable(true);
                    accounts.setDisable(true);
                    fund.setDisable(true);
//                    employee.setTooltip(new Tooltip("Access Has beem Denied!"));
//                    donor.setTooltip(new Tooltip("Access Has beem Denied!"));
//                    accounts.setTooltip(new Tooltip("Access Has beem Denied!"));
//                    fund.setTooltip(new Tooltip("Access Has beem Denied!"));

                }
            }
//            dashboardContent.getChildren().clear();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/clinic/ui/screens/Clinic.fxml"));
    ...
    @FXML
    void clinicActionPerformed(ActionEvent event) {
        try {
            dashboardContent.getChildren();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/clinic/ui/screens/Clinic.fxml"));
            AnchorPane root = loader.load();
